...
- [x] CLI-діагностика `component-guide/components/scan`.
...
- Немає персистентного кешу сканування (лише memoization у межах запиту).
...
- Персистентний кеш сканування + інвалідація при змінах шаблонів.
